...
class example(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        repo.dropCollection("lost") #name of the data link: e.g. station_links
        repo.createCollection("lost")


        repo['alice_bob.lost'].insert_many(r)    #insert data into database?
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        repo = client.repo
        repo.authenticate('alyu_sharontj', 'alyu_sharontj')
        doc.add_namespace('alg', 'http://datamechanics.io/algorithm/name?') # The scripts are in <folder>#<filename> format.
        doc.add_namespace('dat', 'http://datamechanics.io/data/name?') # The data sets are in <user>#<collection> format.
        doc.add_namespace('ont', 'http://datamechanics.io/ontology#') # 'Extension', 'DataResource', 'DataSet', 'Retrieval', 'Query', or 'Computation'.
        doc.add_namespace('log', 'http://datamechanics.io/log/') # The event log.
        doc.add_namespace('bdp', 'https://data.cityofboston.gov/resource/')!!!change to data url

        this_script = doc.agent('alg:alyu_sharontj#example', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})!!!change to file name
